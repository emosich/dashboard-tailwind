      ...
      <div>
        <ul className="pl-4">
          ...
          <li className="bg-[#262837] p-4 rounded-tl-xl rounded-bl-xl">
            <a
              href="#"
              className="bg-[#ff0000] p-4 flex justify-center rounded-xl text-white"
            >
          ...
          <li className="hover:bg-[#262837] p-4 rounded-tl-xl rounded-bl-xl group transition-colors">
            <a
              href="#"
              className="group-hover:bg-[#ff0000] p-4 flex justify-center rounded-xl text-[#ff0000] group-hover:text-white transition-colors"
            >
